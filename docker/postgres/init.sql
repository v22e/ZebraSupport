...
CREATE TYPE plan_tier AS ENUM ('free', 'plus', 'standard', 'pro');
...
VALUES (1, 'ZebraSupport Demo Org', 'standard', NOW(), 'active');

INSERT INTO users (id, org_id, name, email, password_hash, role, active)
VALUES
  (1, NULL, 'Mustapha', 'mustapha@zebrasupport.io', crypt('Zebra1', gen_salt('bf')), 'superadmin', TRUE),
  (2, 1, 'Leo', 'leo@zebrasupport.io', crypt('Zebra1', gen_salt('bf')), 'org_owner', TRUE),
  (3, 1, 'Franco', 'franco@zebrasupport.io', crypt('Zebra1', gen_salt('bf')), 'user', TRUE);
