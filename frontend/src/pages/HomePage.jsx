...
import { Bot, ChevronDown, Gauge, Layers3, Workflow } from "lucide-react";
...
const faqs = [
  {
    q: "What is ZebraSupport?",
    a: "ZebraSupport is a B2B AI-powered customer support ticket platform. It automatically classifies incoming tickets, routes them by priority, and sends instant AI-generated replies to common questions — so your team focuses on what actually needs a human."
  },
  {
    q: "How does the AI auto-reply work?",
    a: "When a ticket is submitted, ZebraSupport classifies its intent and checks it against your FAQ library. If it matches a known topic, an AI-generated reply is sent instantly. If not, the ticket is escalated to your support team with a priority score already attached."
  },
  {
    q: "Do I need to integrate an external AI service?",
    a: "No. ZebraSupport includes a built-in AI reply engine with no external LLM dependency. Everything runs within your stack."
  },
  {
    q: "What subscription plans are available?",
    a: "We offer Free (3 users, 50 tickets/month), Plus (10 users, 500 tickets/month), and Pro (unlimited users and tickets with CSV export). Plan upgrades are handled through our sales team."
  },
  {
    q: "How do I add users to my organisation?",
    a: "Org owners and admins can invite users directly from the admin dashboard. There is no public self-signup — all users are invited and scoped to your organisation."
  },
  {
    q: "Is my data isolated from other organisations?",
    a: "Yes. All ticket, analytics, and user data is strictly scoped to your organisation on the server side. No cross-tenant data access is possible."
  },
  {
    q: "How do I get started?",
    a: "Click 'Book a Demo' and our team will set up your organisation, walk you through the platform, and get your first tickets flowing — usually within the same day."
  }
];
...
const FaqItem = ({ q, a }) => {
  ...
  return (
    <div className="border-b border-black/10 last:border-b-0">
      ...
      {open && <p className="pb-5 text-sm leading-relaxed text-black/70">{a}</p>}
    </div>
  );
};
    ...
    <div className="min-h-screen bg-zebra-white text-black">
      ...
      <main>
        ...
        <section className="mx-auto max-w-3xl px-6 py-14">
          ...
          <div className="mt-8 rounded-2xl border border-black bg-white px-6">
            {faqs.map((item) => (
