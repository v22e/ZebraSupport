    ...
    <div className="space-y-6">
      ...
      <section className="zebra-card overflow-x-auto p-4">
        <table className="min-w-full text-sm">
          ...
          <tbody>
            <tr className="border-t border-black/10"><td className="px-3 py-2 font-semibold">Users</td><td className="px-3 py-2">5</td><td className="px-3 py-2">Unlimited</td></tr>
            <tr className="border-t border-black/10"><td className="px-3 py-2 font-semibold">Tickets/month</td><td className="px-3 py-2">100</td><td className="px-3 py-2">Unlimited</td></tr>
            <tr className="border-t border-black/10"><td className="px-3 py-2 font-semibold">Analytics</td><td className="px-3 py-2">Basic</td><td className="px-3 py-2">Full</td></tr>
            <tr className="border-t border-black/10"><td className="px-3 py-2 font-semibold">CSV Export</td><td className="px-3 py-2">No</td><td className="px-3 py-2">Yes</td></tr>
            <tr className="border-t border-black/10"><td className="px-3 py-2 font-semibold">Support</td><td className="px-3 py-2">Email</td><td className="px-3 py-2">Dedicated</td></tr>
            <tr className="border-t border-black/10"><td className="px-3 py-2 font-semibold">Custom Branding</td><td className="px-3 py-2">No</td><td className="px-3 py-2">Coming Soon</td></tr>
          </tbody>
        </table>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        {["standard", "pro"].map((plan) => {
          ...
          const isDowngrade = currentPlan === "pro" && plan === "standard";
          ...
          return (
            <div key={plan} className={`zebra-card p-5 ${isCurrent ? "opacity-60" : ""}`}>
              ...
              <p className="mt-2 text-sm text-black/70">
                {plan === "standard"
                  ? "Everything you need to get started — 5 users, 100 tickets/month"
                  : "Unlimited users and tickets, full analytics, dedicated support"}
              </p>
      ...
      <p className="text-sm italic text-black/60">
        Plans are assigned by your platform administrator. Contact us to upgrade.
      </p>
